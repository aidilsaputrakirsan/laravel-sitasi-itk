                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mt-2">Masukkan password baru Anda</p>
                                    </div>
                                    ...
                                    <form class="mt-4 pt-2" role="form" method="POST" action="{{ route('password.update') }}">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group auth-pass-inputgroup">
                                                ...
                                                <button class="btn btn-light shadow-none ms-0" type="button" id="password-confirmation-addon">
                                                    <i class="mdi mdi-eye-outline"></i>
                                                </button>
                                            </div>
                                        </div>
