    ...
    <div style="top:10px; padding-left: 10px;">
        <div class="row">
            <div class="col-12">
                <table width="100%">
                    <tr>
                        <td class="text-end" style="padding-right: 50px;"><b>Form. TA-002</b></td>
                    </tr>
                </table>
                ...
                <table width="100%" class="mt-3">
                    ...
                    <tr>
                        <td colspan="4" class="text-end" style="padding-top: 10px; padding-right: 50px; ">Balikpapan, {{ \Carbon\Carbon::now()->isoFormat('D MMMM Y') }}</td>
                    </tr>
                </table>
                ...
                <table width="100%" style="margin-top:10px;">
                    ...
                    <tr>
                        <td>
                            ...
                            <div style="position: relative">
                                <img src="{{ storage_path('app/public/' . $pengajuan->mahasiswa->user->signature) }}" style="position: absolute;left:290px;margin-top:-20px;width:120px;text-align:center">
                            </div>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <div style="position: relative">
                                <img src="{{ storage_path('app/public/' . $pengajuan->pembimbing1->signature) }}" style="position: absolute;left:120px;width:120px;text-align:center">
                            </div>
                            @endif
                        </td>
                        <td>
                            ...
                            <div style="position: relative">
                                <img src="{{ storage_path('app/public/' . $pengajuan->pembimbing2->signature) }}" style="position: absolute;right:100px;width:120px;text-align:center">
                            </div>
                            @endif
                        </td>
                    </tr>
