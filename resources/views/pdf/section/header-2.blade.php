<div style="top: 10px;">
    <div class="row">
        <div class="col-md-3">
            <img src="https://freelance-store.s3.ap-southeast-1.amazonaws.com/logo+itk.png" style="width:80px;position:absolute;left:50px" alt="Logo ITK">
        </div>
        <div class="col-md-12">
            <h3 style="font-size: 18px; font-weight:normal;line-height: 0.8;">KEMENTERIAN PENDIDIKAN TINGGI, SAINS</h3>
            <h3 style="font-size: 18px; font-weight:normal;line-height: 0.8;">DAN TEKNOLOGI</h3>
        ...
        <div class="col-md-12">
            <div style="padding-left:10px;">
                <div style="height: 3px; border-bottom: 4px solid black"></div>
            </div>
        </div>
    </div>
</div>